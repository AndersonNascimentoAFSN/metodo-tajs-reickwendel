Feature: Image Registration
  ...
  Scenario: Submitting an image with valid inputs using enter key
    ...
    # Then I should see a check icon in the title and imageUrl fields // Somente aparece os ícones nos campos quando primeiramente acontece um erro, e depois o campo é preenchido corretamente
    Then I can hit enter to submit the form
    Then The inputs should be cleared

    When I enter "" in the title field
    When I enter "" in the URL field
    Then I can hit enter to submit the form

    When I enter "Alien BR" in the title field
    When I enter "https://cdn.mos.cms.futurecdn.net/eM9EvWyDxXcnQTTyH8c8p5-1200-80.jpg" in the URL field
    Then I should see a check icon in the title and imageUrl fields 
    # Somente aparece os ícones nos campos quando primeiramente acontece um erro, e depois o campo é preenchido corretamente
